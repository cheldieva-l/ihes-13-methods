...
**Актуальный фрейм:** [этапы и назначенные модели](IHES_EXECUTION_PLAN.md).
**Кандидат из MD:** [разбор рецепта](IHES_RECIPE_REVIEW.md).
Ниже сохранена история. Старые очереди и оценка 10 GPU не подменяют текущий план.
Сейчас планирование: дальнейшая реализация и новые запуски отложены.
