...
**Актуальные этапы и модель для каждого участка:** [IHES_EXECUTION_PLAN.md](IHES_EXECUTION_PLAN.md).
Ниже исторический срез доски. Первый новый этап — универсальный обычный 3×3
с точными 18 IHES-генераторами. Сейчас планирование; следующие реализации позже.
